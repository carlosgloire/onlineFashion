...
if (isset($_POST['register'])) {
    ...
    if (empty($firstname) || empty($lastname) || empty($email) || empty($phone) || empty($address) || empty($password) ) {
        ...
        $mail->setFrom("noreply@example.com", "ONLINE FASHION STORE MANAGEMENT SYSTEM");
        ...
        <body>
            <div class="central-div">
                <div class="container">
                    ...
                    <img class="mx-auto" src="https://img.freepik.com/premium-vector/fashion-store-logo-design-vector_18099-2339.jpg" alt="" style="object-fit:cover" width="200px" height="180px">
                    <p>Hello $firstname $lastname,</p>
                    <p>Thank you for signing up with the Online Fashion Store Management System! We’re excited to welcome you to our community. To finalize your registration, please click the "Confirm Account" button below:</p>
                    <p class="btn"><a href='http://localhost/onlineFashion/controllers/confirm-account.php'>Confirm Account</a></p>
                    <hr>
