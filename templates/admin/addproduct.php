                    ...
                    <form action=""  method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <select  style="border: none; width: 100%" class="inputs" name="category" id="">
                                <option value="category_type"> Select product category</option>
                        ...
                        <div class="inputs">
                            <div class="sizes" style="display: flex;text-align:center; gap:20px;flex-wrap:wrap">
                                <?php 
                                $product_sizes = ['XS','S','M','L','XL','XXL','XXXL'];
                                foreach($product_sizes as $product_size){
                                    echo '<div><label>'.$product_size.' <input value="'.$product_size.'" type="checkbox" name="size[]"> </label></div>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <textarea name="description" id="" value="<?= isset($description)? $description:''?>">Product description</textarea>
                        </div>
                        <div class="inputs">
